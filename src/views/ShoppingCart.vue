                            ...
                            <div class="col-lg-12 text-left">
                                <div class="proceed-checkout">
                                    <ul>
                                        ...
                                        <li class="subtotal mt-3">No. Rekening <span>3521 7596 320</span></li>
                                        <li class="subtotal mt-3">Nama Penerima <span>Juhari</span></li>
                                    </ul>
        ...
        methods: {
            ...
            checkout(){
                ...
                let checkoutData = {
                    ...
                    'addres': this.costumerInfo.addres,
