            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        <i class=" fa fa-envelope"></i> separtajuhari@gmail.com
                    </div>
                    <div class="phone-service">
                        <i class=" fa fa-phone"></i> +628 856484131
                    </div>
                </div>
            </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    removeItem(idx) {
        // mencari tahu id dari si item yang akan di hapus
        ...
        // cocokan idx iet dengan id yang ada di storage
